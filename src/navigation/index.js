...
const TabNavigator = () => {
    ...
    return (
        ...
        <Tab.Navigator tabBarPosition='bottom' screenOptions={{
        ...
        }} initialRouteName="home" keyboardDismissMode='on-drag'>
            ...
            <Tab.Screen name="appointments" component={AppointmentsStackScreen} options={{
                title: "",
                tabBarIcon: ({ color, size }) => (
                    <Feather name="calendar" size={24} color={color} />
                ),
            }} />
            <Tab.Screen name="cafeteria" component={CafeteriaStackScreen} options={{
                title: "",
                tabBarIcon: ({ color, size }) => (
