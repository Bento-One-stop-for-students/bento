...
function CafeteriaStackScreen() {
    return (
        <CafeteriaStack.Navigator screenOptions={{
            headerTitleAlign: 'center',
            headerStyle: {
...
const TabNavigator = () => {
    ...
    return (
        ...
        <Tab.Navigator tabBarPosition='bottom' screenOptions={{
            ...
            tabBarIndicatorStyle: {
                ...
                left: (Dimensions.get('window').width / 4 - 19) / 2,
                marginBottom: 9,
                height: 4,
                borderRadius: 100,
        ***REMOVED***,
    ...
    ***REMOVED******REMOVED*** initialRouteName="home" keyboardDismissMode='on-drag'>
            <Tab.Screen name="home" component={HomeStackScreen***REMOVED*** options={{
                title: "",
                tabBarIcon: ({ color, size ***REMOVED***) => (
                    <Feather name="home" size={24***REMOVED*** color={color***REMOVED*** />
                ),
        ***REMOVED******REMOVED*** />
            <Tab.Screen name="appointments" component={AppointmentsStackScreen***REMOVED*** options={{
                title: "",
                tabBarIcon: ({ color, size ***REMOVED***) => (
                    <Feather name="calendar" size={24***REMOVED*** color={color***REMOVED*** />
                ),
        ***REMOVED******REMOVED*** />
            <Tab.Screen name="cafeteria" component={CafeteriaStackScreen***REMOVED*** options={{
                title: "",
                tabBarIcon: ({ color, size ***REMOVED***) => (
                    <Feather name="shopping-bag" size={24***REMOVED*** color={color***REMOVED*** />
                ),
        ***REMOVED******REMOVED*** />
            <Tab.Screen name="settings" component={SettingsStackScreen***REMOVED*** options={{
                title: "",
                tabBarIcon: ({ color, size ***REMOVED***) => (
