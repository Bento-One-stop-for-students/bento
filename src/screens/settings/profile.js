  ...
  return (
    <View className="border-t flex-1 items-center justify-start bg-white">
      ...
      <View className="flex-row justify-between w-full px-6 mt-6">
        ...
        <TextBox class="text-lg font-normal">{name}</TextBox>
      </View>
      <View className="flex-row justify-between w-full px-6 mt-6">
        <TextBox class="text-lg font-normal" bold>
          E-mail
        </TextBox>
        <TextBox class="text-lg font-normal">{user.email}</TextBox>
      </View>
      ...
      <View className="flex-row justify-between w-full px-6 mt-6">
        ...
        <TextBox class="text-lg font-normal">{user.room_no}</TextBox>
      </View>
      <View className="flex-row justify-between w-full px-6 mt-6">
        <TextBox class="text-lg font-normal" bold>
          Hostel
